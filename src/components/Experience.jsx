...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      ref={containerRef}
      className="relative py-20 sm:py-24 md:py-28 lg:py-[120px] px-4 md:px-0 overflow-hidden"
    >
      {/* Aesthetic Ambient Background Glows & Accent Line */}
      <div className="pointer-events-none absolute left-1/2 top-10 -translate-x-1/2 w-full max-w-4xl h-72 bg-gradient-to-r from-primary/10 via-secondary/10 to-transparent blur-3xl opacity-60 rounded-full" />
      ...
      <div className="max-w-[800px] mx-auto relative z-10">
        ...
        <div className="mb-12 text-center sm:mb-14 md:mb-16">
          {/* Badge Style Tag */}
          <div className="mb-4 inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-primary/20 bg-primary/10 backdrop-blur-md shadow-sm">
        ...
        <div className="space-y-12 relative max-w-2xl mx-auto">
          ...
          <div className="absolute left-[15px] top-4 bottom-4 w-0.5 bg-base-content/10"></div>

          {/* Animated Glowing Timeline Line */}
          <div className="timeline-line absolute left-[15px] top-4 w-0.5 bg-gradient-to-b from-primary via-secondary to-transparent origin-top shadow-[0_0_12px_rgba(var(--p),0.8)]"></div>
