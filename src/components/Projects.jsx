...
const projects = [
  {
    title: 'BookVibe',
    description: 'A personalized reading tracker and book discovery platform for bibliophiles to manage their library.',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB-50JjytXNJFKykWCqCgNbqLjGSFiVlIWVR7RNPqCwdQ7zI64V8cPoLG8xfcCEXai5oYyavyb5Ld3gbxYQ7GXfdk5cJfiT64qtk4cnm-nnF6ASWCxWlCoiqFAvb8p6SzVyRKeVmAqw4A_WzKDFAOtuJAzbj52E3vLsU55mOHdIFcvVjVfuY3CY_s8Ye7x9y7rK3revBQEhIn2ee9lB49boAIZcqRXRp60-JKjbH051MvNylWMGRv_vVZwbeTt1gpbIU3ovhA6qCH4',
    tags: ['React', 'Firebase'],
  },
  {
    title: 'TaskFlow',
    description: 'Enterprise-grade task management system with real-time collaboration features and intuitive kanban boards.',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCKYUIUiiG4fudYy1kDgMmtDPg6PIP720DnVVcCP6UIY5mAxppz3zMrmBunZrDNse0ijUkGh_sGZci8ngsOTJrdIHeETdr-4E2-930s5RMjWS8zwjrfso-Yt3eYg0ptut_2FKJygsyi5YTPT70m6NiKz8lnnDIpLVW_9-pkv3GB4czsK1gC0cZ7qVbXNge-4uSh9wHuSUFVYcmpxfBAvx7xQ9N2pe_RZSn9IxgCFQ65vDRkiVSLlCJ0sBBxIRMtVNev4g_jL29uUS0',
    tags: ['Next.js', 'MongoDB'],
  },
  {
    title: 'Portfolio Website',
    description: 'A high-performance personal portfolio built with modern web standards and fluid animations.',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCdBqpN39ScEbrhhmv5DCqEwqY3S4_t3DdX5pOVqtUdPMsB3Is-z0RcZC26a0FUxmTzeAM3SCrYX94nHAR29KE4v7vFjzJCfFtDY_8va-RBnXG324JSHAO9cFTKX1OEoWSAaw2MhnnKH2OVS3a_blVPqUgm8J7VsuFs0iIEL3CjvxxRhVSneZp5xkgfWe606vdxeeihaHLMGu1KOQJAZO6B_SSQ5mpK_XodwKYlEd0cLqkUyOiWddMYU3McU6LtfZe_17bJMLXLMwI',
            ...
            <div className="p-10">
              <div className="flex gap-3 mb-6">
                {project.tags.map(tag => (
                  <span key={tag} className="badge badge-sm badge-secondary badge-outline px-3 py-3 text-[10px] font-bold uppercase tracking-wider">{tag}</span>
                ))}
              </div>
              <h3 className="text-2xl font-bold mb-4 text-base-content">{project.title}</h3>
              <p className="text-base-content/60 leading-relaxed line-clamp-3 mb-8">{project.description}</p>
