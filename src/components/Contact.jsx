...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-[120px] px-4 md:px-0">
      <motion.div
          ...
          <form className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                ...
                <div key={field.label} className="form-control group">
            ...
            <div ref={buttonRef} className="inline-block w-full sm:w-auto">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="btn btn-primary w-full sm:px-12 h-16 rounded-2xl text-lg font-bold shadow-xl shadow-primary/20 flex items-center justify-center gap-3"
              >
                Send Message
